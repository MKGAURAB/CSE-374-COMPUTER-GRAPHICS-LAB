...
// Custom structure for storing point
struct POINT
{
    int x, y;
};

// Drawing a Line in the Buffer
...
//Calculating the 4bit code of a point of a Line
...
//Clipping a Line. This fucntion returns the clipped point
...
// Applying the Standard CohenSutherLand Algorithm
...
void display(void)
{
    ...
    //Drawing the Main line to be clipped
    DrawLine(x1,y1,x2,y2);
    glColor3d(1,1,1);       //White Color code
    //Applying CohenSutherLand and Drawing the Clipped portion with White color.
